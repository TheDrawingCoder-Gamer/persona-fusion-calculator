...
// Apparently this has VERY strict order and formatting. oopsies!
const personae = [
    ...
    {'arcana': 'Fool',        'level': 24, 'name': 'Orpheus',           'special': true},
    ...
    { 'arcana': 'Lovers', 'level': 6, 'name': 'Alp' },
    ...
    { 'arcana': 'Chariot', 'level': 30, 'name': 'Oumitsunu', },
    ...
    { 'arcana': 'Fortune', 'level': 23, 'name': 'Empusa' },
    ...
    { 'arcana': 'Hanged Man', 'level': 48, 'name': 'Ubelluris', },
    {'arcana': 'Hanged Man',  'level': 49, 'name': 'Yatsufusa',         'special': true },
    { 'arcana': 'Hanged Man', 'level': 50, 'name': 'Hecatoncheires' },
    ...
    {'arcana': 'Death',       'level': 64, 'name': 'Thanatos',          'special': true},
    ...
    { 'arcana': 'Temperance', 'level': 22, 'name': 'Jikokuten' },
    ...
    { 'arcana': 'Tower', 'level': 60, 'name': 'Bishamonten' },
    ...
    { 'arcana': 'Moon', 'level': 67, 'name': 'Dionysus' },
    ...
    { 'arcana': 'Judgement', 'level': 81, 'name': "Messiah", 'special': true },
...
const specialCombos = [
    ...
    {'result': 'Chi You', 'sources': ['White Rider', 'Hecatoncheires', 'Thor', 'Yoshitsune']},
    {'result': 'Messiah', 'sources': ['Thanatos', 'Orpheus']},
    {'result': 'Orpheus', 'sources': ['Izanagi', 'Obariyon', 'High Pixie']},
    {'result': 'Orpheus Telos', 'sources': ['Asura', 'Messiah', 'Thanatos', 'Chi You', 'Ardha', 'Helel']},
    {'result': 'Thanatos', 'sources': ['Ghoul', 'Pale Rider', 'Loa', 'Mot', 'Samael', 'Alice']},
    ];
